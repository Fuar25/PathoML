...
2. **Same `BASE_SEED`, `K_FOLDS`, `N_RUNS`** — these are defined in `common.py` and shared by all `runs/` scripts. External scripts (e.g. under `scripts/`) must replicate these values.
